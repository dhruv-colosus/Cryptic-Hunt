    ...
    <div>
        ...
        <div className="flex justify-between my-4 mx-3 ">
          ...
          <div>
            <div className="py-1.5 px-4">
              <div>
                <a href="#">
                  <Image src={"/images/Logo_dark_white.png"}  alt="hello" width="1000" height="300" className=" w-[30vw] sm:w-[12vw] md:w-[12vw] lg:w-[12vw] xl:w-[12vw]">
                  </Image>
                </a>
              </div>
            </div>
      ...
      <div className="bg-[#OBOBOB] h-full my-[30vh] sm:mt-44 md:mt-44 lg:mt-44 xl:mt-44 transition-all duration-300" >
        <div className="flex flex-col items-center">
          ...
          <div className="pb-4">
            <div>
              <h3 className="text-[#00C29A] font-montserrat tracking-[0.75rem] sm:tracking-[1.75rem] md:tracking-[1.75rem] lg:tracking-[1.75rem] xl:tracking-[1.75rem]
      ...
      <div className="mt-[6vw] mx-4 mb-4 absolute bottom-0 right-0">
        <div className="flex flex-col items-end">
          ...
          <div className="py-1">
            <a href="#">
              <div className=" flex items-center overflow-hidden bg-[#00C29A] p-3 sm:p-3 md:p-3 lg:p-3 xl:p-3 w-10 sm:w-16 md:w-16 lg:w-16 xl:w-16 h-10 sm:h-16 md:h-16 lg:h-16 xl:h-16 
          ...
          <div className="py-1">
            <a href="#">
              ...
              hover:w-[9.75rem] sm:hover:w-[12.9rem] md:hover:w-[12.9rem] lg:hover:w-[12.9rem] xl:hover:w-[12.9rem]  hover:bg-[#000000] hover:border-2 hover:border-[#00C29A] transition-all duration-300 text-[#00C29A]">
                  ...
                  <Image src={"/images/monkey.png"} width={100} height={100} alt="Rulebook" loading="eager" className="w-6 sm:w-10 md:w-10 lg:w-10 xl:w-10">
                  </Image>
