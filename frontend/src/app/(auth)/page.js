    ...
    return (
        <>
            <div className="h-fit sticky top-0 ">
                ...
                <div className="bg-[#OBOBOB] h-full py-[30vh] sm:pt-44 md:pt-44 lg:pt-44 xl:pt-44 transition-all duration-300">
            ...
            >
              <div className="py-2 px-12 ">
                ...
                <div className="mt-[6vw] mx-4 mb-4 absolute bottom-0 right-0">
                    <div onClick={rulesRule} className="flex flex-col items-end">
                        <div className="py-1">
                                <div
            ...
            <Rulebook rules1={rules1} rulesRule={rulesRule} />
        </>
    );
}
