    ...
    return (
        <>
            <div className="flex justify-center items-center h-screen bg-background">
                ...
                px-2 py-2 font-sub bg-background" placeholder="Enter Team Name ..." onChange={e => setTeamname(e.target.value)} value={teamname} />
                    </div>
                    <div className="mt-7">
                ...
                px-2 py-2 font-sub bg-background " placeholder="(1-4)" onChange={e => setMember(e.target.value)} value={member} />
                    </div>
                ...
                sm:py-2 py-1 sm:px-12 px-10 border-2 border-main font-button hover:bg-background hover:text-main"
                            ...
                            onClick={() => {
                                createTeam.mutate({ teamname, member }, {
                                    onSuccess: () => {
                                        userQuery.refetch()
                                    },
                                    onError: (err) => {
